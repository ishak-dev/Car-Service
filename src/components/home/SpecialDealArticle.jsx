...
import "../../style/components/home/specialDealArticle.css";
const SpecialDealArticle = () => {
  return (
    <div className="special-article-card list-card">
      ...
      <div className="card-body">
        ...
        <div className="row">
          <div className="col-9">
            <p className="special-card-original-price">300$</p>
          </div>
          <div className="col-3">
...
export default SpecialDealArticle;
